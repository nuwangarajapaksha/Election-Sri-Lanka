...
<html>
    ...
    <body>
       <div class="reg-container reg-popup" id="voterpasswordchange">
            <img src="img/Close_Cross_Icon.png" onclick="togglevoterpasswordchangepopup();"/>
            <p>Change Password</p>
            <form method="post" action="action/voter_password_changer.php">
                <input type="hidden" name="nic" id="nic" value="<?php echo $activeNic; ?>" placeholder="Administrator No" readonly/>
