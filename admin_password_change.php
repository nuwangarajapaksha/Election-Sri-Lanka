...
<html>
    ...
    <body>
        <div class="reg-container reg-popup" id="adminpasswordchange">
            ...
            <p>Change Password</p>
            <form method="post" action="action/admin_password_changer.php">
                <input type="hidden" name="no" id="no" value="<?php echo $activeNo; ?>" placeholder="Administrator No" readonly/>
